...
--> Weitere Erklärung noch aus Buch S.465
...
Eine Analyse der Variablen der 2. Komponente zeigt, dass die gestellten Fragen von der Mehrheit stark abgelehnt werden. 
...
In der weiteren Analyse wird daher mit einer metrischen und normalverteilten abhängigen Variable weitergearbeitet. 
...
+-----------+--------------------------------------------------------------------+
| H~0~:     | Die Fremdenfeindlichkeit unterscheidet sich bei Männern und Frauen |
+-----------+--------------------------------------------------------------------+
