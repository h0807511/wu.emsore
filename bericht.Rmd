...
```
\begin{center}
\textit{Abbildung `r I(c_plots <- c_plots + 1)` + `r I(c_plots <- c_plots + 1)`: Moderate Fremdenfeindlichkeit nach Geschlecht}
\bigskip
\end{center}
...
```
\begin{center}
\textit{Abbildung `r I(c_plots <- c_plots + 1)`: Agressive Fremdenfeindlichkeit nach Geschlecht}
\bigskip
\end{center}
