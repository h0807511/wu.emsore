...
* in ~5 Fällen wurden bereits angekreuzte Items wieder ausgebessert (Beispiel: FB Nr. 95/F5, )
...
Folgende Fragebögen haben fast ausschliesslich NA bei den Antworten und wurden aus der Auswertung ersatzlos gestrichen:

* FB Nr. 47
* FB Nr. 65

```{r rows mit vielen NA entfernen}
# fragebogen <- fragebogen[-c(47, 66), ]
```
