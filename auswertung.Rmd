...
library(knitr)
kable(fragebogen[1:5, ], caption = "A knitr kable.")
```
...
na_count <- sapply(fragebogen, function(y) sum(is.na(y)))
kable(na_count, format = "latex", digits = 2, longtable = TRUE)
```

\begin{center}
\textit{Tabelle 2: Übersicht der NA im Datensatz}
\bigskip
\end{center}
...
\begin{center}
\textit{Abbildung 2.1: Frage nach Geschlecht}
\bigskip
\end{center}
...
+----------------------------------+-----------------------------------------------------------------------------------------+
| **Nullhypothese H~0~**           | Die Verteilung der Geschlechter unterscheidet sich *nicht* von der erwarteten Verteilung  |
+----------------------------------+-----------------------------------------------------------------------------------------+
| **Alternativhypothese H~A~**     | Die Verteilung der Geschlechter unterscheidet sich von der erwarteten Verteilung        |
+----------------------------------+-----------------------------------------------------------------------------------------+
